...
public class SimplifiedOdometryRobot {
    ...
    public void initialize(boolean showTelemetry)
    {
        ...
        leftFrontDrive  = setupDriveMotor("LFMotor", DcMotor.Direction.REVERSE);
        rightFrontDrive = setupDriveMotor("RFMotor", DcMotor.Direction.FORWARD);
        leftBackDrive  = setupDriveMotor( "LBMotor", DcMotor.Direction.FORWARD);
        rightBackDrive = setupDriveMotor( "RBMotor",DcMotor.Direction.FORWARD);
        imu = myOpMode.hardwareMap.get(IMU.class, "imu");

        //  Connect to the encoder channels using the name of that channel.
        driveEncoder = myOpMode.hardwareMap.get(DcMotor.class, "RSlide");
        strafeEncoder = myOpMode.hardwareMap.get(DcMotor.class, "LSlide");
